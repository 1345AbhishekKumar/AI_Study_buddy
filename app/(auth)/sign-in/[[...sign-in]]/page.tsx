                      ...
                      <CardContent className="space-y-4">
                        <SignIn.SupportedStrategy name="email_code" asChild>
                          <Button
                            ...
                            variant="outline"
                            disabled={isGlobalLoading}
                            className="w-full border-blue-200 dark:border-blue-800 hover:bg-blue-50 dark:hover:bg-blue-950 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200 py-6"
                          >
                          ...
                          <div className="grid w-full gap-y-4">
                            <SignIn.Action submit asChild>
                              ...
                              >
                                <Clerk.Loading>
                                  {isLoading => {
                                    return isLoading ? <Icons.spinner className="size-4 animate-spin" /> : 'Sign In';
                                  }}
                                </Clerk.Loading>
                              </Button>
                            </SignIn.Action>
